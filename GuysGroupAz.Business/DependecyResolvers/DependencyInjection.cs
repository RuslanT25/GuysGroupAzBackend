...
namespace GuysGroupAz.Business.DependecyResolvers
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddBusinessModule(this IServiceCollection services)
        {
            ...
            services.AddScoped<IGenericRepository<VacancyDescription>, GenericRepository<VacancyDescription>>();
            ...
            services.AddScoped<IGenericRepository<VacancyDetail>, GenericRepository<VacancyDetail>>();
